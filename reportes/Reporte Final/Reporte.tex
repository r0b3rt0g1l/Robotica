...
\begin{document}
	...
	\input{capitulos/Desarrollo/Introduccion}
		...
		\input{capitulos/Desarrollo/Caracteristicas/Resumen_tabla}
		\input{capitulos/Desarrollo/Caracteristicas/Geometria_DH}
	...
	\chapter{Resultados y Conclusiones} \label{chap:resultados_conclusiones}
	
	\section{Resultados} \label{sec:resultados}
	\subsection{Gráficas de Cinemática} \label{subsec:graficas_cinematica}
	\input{capitulos/Resultados/Graficas_Cinematica}
	
	\subsection{Gráficas de Dinámica} \label{subsec:graficas_dinamica}
	\input{capitulos/Resultados/Graficas_Dinamica}
	
	\section{Conclusiones individuales} \label{sec:conclusiones}
	\input{capitulos/Resultados/Conclusiones_Panchito}
	\input{capitulos/Resultados/Conclusiones_Juanito}
